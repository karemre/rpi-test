...
DOCKER_IMAGE_NAME=eyigitoglu/raspberrypitest
...
build:
	...
	docker build -t eyigitoglu/raspberrypitest .
	docker tag -f $(DOCKER_IMAGE_NAME) $(DOCKER_IMAGE_NAME):latest
...
test:
	docker run --rm eyigitoglu/raspberrypitest /bin/busybox echo "Success."
